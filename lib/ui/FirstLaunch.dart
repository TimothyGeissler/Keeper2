...
class FirstLaunch extends StatefulWidget {
  FirstLaunch({Key key}) : super(key: key);

  @override
  _FirstLaunchState createState() => new _FirstLaunchState();
}

class _FirstLaunchState extends State<FirstLaunch> with SingleTickerProviderStateMixin {
            ...
            children: <Widget>[
              Card(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.only(top: 20.0, bottom: 02.0, left: 25.0, right: 25.0),
                        child: TextField(
              ...
              Container(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () async {
                      if (newPasswordController.text == "" || newPasswordController.text == null) {
                        print("Null password");
                        //Blank
                        showDialog(
                          context: context,
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: ConstrainedBox(
                                ...
                                child: Column(children: [new Text("Cannot be empty")]),
                              ),
                              actions: <Widget>[
                                new FlatButton(
                                  child: new Text("OK"),
                        ...
                        //password OK
                        SharedPreferences prefs = await SharedPreferences.getInstance();
                        String encryptedPassword = await cryptor.encrypt(newPasswordController.text, key);
                        prefs.setString("password", encryptedPassword);
                        print(newPasswordController.text + " -> " + encryptedPassword);
                        //save encryption key
